...
<NavLink :href="route('cultivos')" :active="route().current('cultivos')">
    Mis Cultivos
</NavLink>
...
<NavLink :href="route('ventas')" :active="route().current('ventas')">
    Ventas
</NavLink>
                            </div>
                        </div>
...
<ResponsiveNavLink :href="route('cultivos')" :active="route().current('cultivos')"> 
    Mis Cultivos 
</ResponsiveNavLink>
